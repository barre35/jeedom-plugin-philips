...
<div class="row row-overflow">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 eqLogicThumbnailDisplay">
        ...
        <!—- Container d’une liste -->
      	...
      	<legend><i class="fab fa-tv"></i> {{Mes équipements}}</legend>
        ...
        <div class="eqLogicThumbnailContainer" style="position: relative; height: 180px">
            ...
            <?php foreach ($eqLogics as $eqLogic) : ?>
            	...
            	<div class="eqLogicDisplayCard cursor" data-eqlogic_id="<?php echo $eqLogic->getId(); ?>" style="position: absolute; left: 0px; top: 0px;">
    				<img style="margin-bottom:5px" src="plugins/philips/ressources/equipment.png"><br>    
	...
	<div class="col-lg-12 col-md-12 col-sm-12 eqLogic" style="display: none; padding-top: 5px; height: 710px; overflow: hidden auto;">
		...
		<div class="input-group pull-right" style="display:inline-flex">
        	...
        	<span class="input-group-btn">
				<a class="btn btn-success btn-sm eqLogicAction" data-action="save"><i class="fa fa-check-circle"></i> {{Sauvegarder}}</a><a class="btn btn-danger btn-sm eqLogicAction roundedRight" data-action="remove"><i class="fa fa-minus-circle"></i> {{Supprimer}}</a>
			</span>
		...
		<div class="tab-content" style="height:calc(100% - 50px);overflow:auto;overflow-x: hidden;">
        	...
        	<!-- =================== -->
  			...
  			<div style="display: none;" id="md_philips_alert"></div>
                  	...
                  	<div class="col-sm-12">
                  		...
                  		<fieldset>
                            ...
                            <div class="form-group">
                    			...
                    			<div class="col-sm-2">
			                    	<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="IPaddress" rows="2" />
                    			</div>
                  			</div>
                            ...
                            <div class="form-group">
                    			...
                    			<div class="col-sm-2">
			                    	<input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="user" style="display : none"/> 
                                    <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="auth_key" />
                                    <input class="eqLogicAttr form-control" data-l1key='configuration' data-l2key='timestamp' style="display : none"/> 
                                    <input class="eqLogicAttr form-control" data-l1key='configuration' data-l2key='timeout' style="display : none"/> 
                    			</div>                                
                                <div class="col-sm-2">
                        			<a class="btn btn-danger eqLogicAction" onclick="getKey()"><i class="fa fa-sync"></i> {{Appairer}}</a>
                    			</div>
                  			</div>
                            ...
                            <div class="form-group">
                    			...
                    			<div class="col-sm-2">
			                    	<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="pin"  />
                    			</div>
                                <div class="col-sm-2">
                        			<a class="btn btn-danger eqLogicAction" onclick="getToken()"><i class="fa fa-sync"></i> {{Approuver}}</a>
                    			</div> 
                  			</div>
...
include_file('desktop', 'philips', 'js', 'philips'); 
